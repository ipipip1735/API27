        ...
        mConnectionCallbacks =
                new MediaBrowserCompat.ConnectionCallback() {
                    ...
                    public void onConnected() {
                        ...
                        try {
                            MediaControllerCompat mediaController = new MediaControllerCompat(NotificationsActivity.this, token);
                            mediaController.registerCallback(controllerCallback); //控制器注册回调
                            MediaControllerCompat.setMediaController(NotificationsActivity.this, mediaController);
...
//                            asyncTask.execute(mediaController);
        ...
        mMediaBrowser = new MediaBrowserCompat(this,
                new ComponentName(this, MediaPlaybackForegroundService.class),//启动前台服务
                mConnectionCallbacks,
                rootHint);
...
//        mediaController.getTransportControls().seekTo(mediaController.getPlaybackState().getPosition() - 3000L);
    ...
    public void prepare(View view) {
        ...
        setVolumeControlStream(AudioManager.STREAM_MUSIC);
        MediaControllerCompat mediaController = MediaControllerCompat.getMediaController(NotificationsActivity.this);
